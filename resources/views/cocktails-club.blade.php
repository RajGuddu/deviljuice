...
<body>
   ...
   <div class="header">
    ...
    <div class="banner homne-banner coctail-banner coctail-club-bannr"
        ...
        <div class="container-fluid">
            <h1 class="banner-title mx-auto text-center">Cocktails Club</h1>
            <p class="banner-subtitle mx-auto text-center w-100">Step inside the Cocktails Club — a place built for the
                daring, the creative, and the ones who pour with passion.</p>
        </div>
    </div>
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-img-overlay d-flex flex-column justify-content-between p-2">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="small text-light px-2">
                                    Upload your cocktail recipe and photo — join the Devil’s circle and let the world
                                    taste your fire.
                                </p>
                            </div>

                            <div class="mb-4">
                                <a href="#" class="btn custom-btn text-uppercase text-decoration-none">Submit Your
                                    Cocktail</a>
                            </div>
            ...
            <div class="panel-space pb-0">
                <div class="load-more-container">
                    <div class="line"></div>
                    <button class="load-btn">Load more cocktail</button>
                    <div class="line"></div>
                </div>
            </div>
