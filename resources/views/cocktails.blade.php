...
<body>
   ...
   <div class="header">
    ...
    <div class="banner homne-banner coctail-banner" style="background-image: url({{ asset('assets/frontend/images/coctel-banner.jpg') }});">
        <div class="container-fluid">
            <h1 class="banner-title mx-auto text-center">Pure. Powerful. Devilishly Smooth.</h1>
            <p class="banner-subtitle mx-auto text-center w-100">A vodka so pure it tempts the fearless — smooth enough
                to seduce, bold enough to burn.</p>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="d-md-flex align-items-center justify-content-between mb-5">
                <div class="search-bar">
                    <input type="text" placeholder="search by name or ingredients">
                    <button class="search-icon" aria-label="Search">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </button>
                </div>

                <p class="mb-0 weight-600">21 Cocktails</p>
