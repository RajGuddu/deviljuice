   ...
   <div class="header">
    ...
    <div class="vodka-banner panel-space">
        <div class="container-fluid text-center">
            <h1 class="banner-title text-center w-100 mt-5">THE STORY OF DEVIL’S JUICE</h1>
            <p class="text-center">Boldly Distilled. Fearlessly Crafted. Unmistakably Devil.</p>
        </div>
    </div>
    ...
    <section class="panel-space first-shots text-center overflow-hidden the-story-filre-panel">
        ...
        <video class="bg-video" autoplay="" muted="" loop="" playsinline="">
            <source src="{{ asset('assets/frontend/videos/the-story-filre.mp4') }}" type="video/mp4">
        </video>

        <!-- Content -->
        <div class="content w-50 text-start">
            <h2 class="h2-heading weight-600 mb-4">Yahan Apna Title Likhein</h2>
    ...
    <section class="born-from-obsession">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-3">
                    <img src="{{ asset('assets/frontend/images/obsession-1.png') }}" alt="" class="w-100 d-md-block d-none">
                </div>
                <div class="col-md-6 text-center">
                    <h2 class="h2-heading weight-600 mb-4">Born From Obsession</h2>
                ...
                <div class="col-md-3">
                    <img src="{{ asset('assets/frontend/images/obsession-2.png') }}" alt="" class="w-100 d-md-block d-none">
                </div>
            </div>
        </div>
    </section>
